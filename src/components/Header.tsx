...
const Header = () => {
  ...
  return (
    <header className="relative bg-gradient-to-r from-sky-400 via-blue-500 to-blue-600 min-h-[120px] flex items-center">
        ...
        <div className="bg-white rounded-2xl shadow-lg px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:block">
              <Button variant="hero" className="px-8 py-3 text-sm font-bold tracking-wide">
                LET'S BUILD
              </Button>
            </div>
